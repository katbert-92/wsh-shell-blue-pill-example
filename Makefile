...
INCLUDE_FLAGS_COMMON += -I$(EXAMPLE_DIR)/platform/STM32CubeF1/Drivers/CMSIS/Include
INCLUDE_FLAGS_COMMON += -I$(EXAMPLE_DIR)/platform/STM32CubeF1/Drivers/CMSIS/Core/Include
INCLUDE_FLAGS_COMMON += -I$(EXAMPLE_DIR)/platform/STM32CubeF1/Drivers/CMSIS/Device/ST/STM32F1xx/Include
...
DEBUG_FLAGS := -O0 -g -DWSH_SHELL_ASSERT_ENABLE -DWSH_SHELL_DEBUG_ENABLE -DUSE_FULL_ASSERT -DDEBUG_ENABLE
