...
/* Macro: BE_NO_PRINTF_LONGLONG
 * Disable usage of "%lld"/"%llu" format specifiers for printf().
 * Some embedded C libraries (e.g. newlib-nano) do not support
 * long long printing even with -u _printf_long_long.
 * When set to 1, Berry will use an internal conversion function
 * to print 64-bit integers safely on platforms without printf
 * long long support.
 * Default: 0
 */
#define BE_NO_PRINTF_LONGLONG			0
 ...
 * Default: 32kb
 **/
#define BE_BYTES_MAX_SIZE               (5 * 1024)   /* 32 kb default value */
 ...
 * Default: 20000
 **/
#define BE_STACK_TOTAL_MAX              10000
...
// extern void* be_malloc_impl(size_t size);
// extern void be_free_impl(void* ptr);
// extern void* be_realloc_impl(void* ptr, size_t new_size);
 ...
 **/
#define be_assert(expr)                 ASSERT_CHECK(expr)
